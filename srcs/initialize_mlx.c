...
void	initialize_mlx(t_mlx *mlx, t_loader loader)
{
	...
	mlx->img.handle = ft_x_mlx_new_image(mlx->handle, WINDOW_WIDTH,
			WINDOW_HEIGHT);
	mlx->img.buffer = mlx_get_data_addr(mlx->img.handle,
