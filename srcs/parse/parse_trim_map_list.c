...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_trim_map_list.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tyamauch <tyamauch@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/13 14:35:04 by tyamauch          #+#    #+#             */
/*   Updated: 2024/08/13 14:35:05 by tyamauch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_map_node	*find_last(t_map_node *ptr, char *trimed_node_val)
{
	...
	while (next_ptr)
	{
		if (!ft_isequal(ptr->val, trimed_node_val) && ft_isequal(next_ptr->val,
				trimed_node_val))
		{
